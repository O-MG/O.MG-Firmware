...
class ESPLoader(object):
    ...
    def connect(self, mode='default_reset'):
        ...
        raise FatalError('Failed to connect to %s: %s | \n \n ERROR: A programmer is detected, but no cable seems plugged in. Please try unplugging and replugging the cable and/or programmer. Please also make sure only one programmer is connected.' % (self.CHIP_NAME, last_error))
